...
class ExchangeRateMarkerView constructor(context: Context) : MarkerView(context, R.layout.exchange_rate_marker) {
    ...
    private val rateTextView: TextView = findViewById(R.id.exchange_rate_chart_marker_rate_text)
    private val dateTextView: TextView = findViewById(R.id.exchange_rate_chart_marker_date_text)
